...
read_vhdl -library xil_defaultlib {{C:/Users/Ali Gholami/Desktop/onGoing/Digital Design of Computer Systems/assignments/Assignment_3/_VHDL/fb_adder/fb_adder.srcs/sources_1/new/fb_adder.vhd}}
synth_design -top ADD4 -part xc7vx485tffg1157-1
write_checkpoint -noxdef ADD4.dcp
catch { report_utilization -file ADD4_utilization_synth.rpt -pb ADD4_utilization_synth.pb }
