...
HD_PWD='C:/Users/Ali Gholami/Desktop/onGoing/Digital Design of Computer Systems/assignments/Assignment_3/_VHDL/fb_adder/fb_adder.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ADD4.vdi -applog -m64 -messageDb vivado.pb -mode batch -source ADD4.tcl -notrace
