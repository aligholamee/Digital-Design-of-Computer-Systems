...
HD_PWD='C:/Users/Ali Gholami/Desktop/onGoing/Digital Design of Computer Systems/assignments/Assignment_2/_VHDL/odd_even_sortnet/odd_even_sortnet.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log comparator.vds -m64 -mode batch -messageDb vivado.pb -notrace -source comparator.tcl
