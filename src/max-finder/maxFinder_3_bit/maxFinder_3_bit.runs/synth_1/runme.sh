...
HD_PWD='C:/Users/Ali Gholami/Desktop/onGoing/Digital Design of Computer Systems/Assignments/Assignment_1/_VHDL/maxFinder/maxFinder_3_bit/maxFinder_3_bit.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log maxFinderModule_3_input.vds -m64 -mode batch -messageDb vivado.pb -notrace -source maxFinderModule_3_input.tcl
