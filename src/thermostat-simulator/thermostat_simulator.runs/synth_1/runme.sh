...
HD_PWD='C:/Users/Ali Gholami/Desktop/onGoing/Digital Design of Computer Systems/assignments/Assignment_3/_VHDL/thermostat_simulator/thermostat_simulator.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Thermostat.vds -m64 -mode batch -messageDb vivado.pb -notrace -source Thermostat.tcl
