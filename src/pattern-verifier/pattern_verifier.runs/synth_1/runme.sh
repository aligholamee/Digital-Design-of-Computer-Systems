...
HD_PWD='C:/Users/Ali Gholami/Desktop/onGoing/Digital Design of Computer Systems/assignments/Assignment_4/_VHDL/pattern_verifier/pattern_verifier.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log PatternVerifier.vds -m64 -mode batch -messageDb vivado.pb -notrace -source PatternVerifier.tcl
