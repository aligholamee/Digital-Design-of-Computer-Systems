...
HD_PWD='C:/Users/Ali Gholami/Desktop/onGoing/Digital Design of Computer Systems/assignments/Assignment_4/_VHDL/light_controller/light_controller.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log LightControl.vds -m64 -mode batch -messageDb vivado.pb -notrace -source LightControl.tcl
