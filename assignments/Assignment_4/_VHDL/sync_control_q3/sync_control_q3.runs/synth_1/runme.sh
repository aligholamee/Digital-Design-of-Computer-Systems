...
HD_PWD='C:/Users/Ali Gholami/Desktop/onGoing/Digital Design of Computer Systems/assignments/Assignment_4/_VHDL/sync_control_q3/sync_control_q3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SyncControl.vds -m64 -mode batch -messageDb vivado.pb -notrace -source SyncControl.tcl
