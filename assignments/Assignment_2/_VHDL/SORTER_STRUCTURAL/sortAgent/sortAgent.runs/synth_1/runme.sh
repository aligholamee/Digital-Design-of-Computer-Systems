...
HD_PWD='C:/Users/Ali Gholami/Desktop/onGoing/Digital Design of Computer Systems/assignments/Assignment_2/_VHDL/SORTER_STRUCTURAL/sortAgent/sortAgent.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sortModule.vds -m64 -mode batch -messageDb vivado.pb -notrace -source sortModule.tcl
