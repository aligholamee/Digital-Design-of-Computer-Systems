...
HD_PWD='C:/Users/Ali Gholami/Desktop/onGoing/Digital Design of Computer Systems/assignments/Assignment_2/_VHDL/BCD_ADDER/bcd_adder/bcd_adder.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log BCD_ADDER.vds -m64 -mode batch -messageDb vivado.pb -notrace -source BCD_ADDER.tcl
