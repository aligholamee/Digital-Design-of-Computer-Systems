...
HD_PWD='C:/Users/Ali Gholami/Desktop/Desktop new/onGoing/Digital Design of Computer Systems/assignments/Assignment_6/_VHDL/Register_Controller/Register_Controller.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log RegisterController.vds -m64 -mode batch -messageDb vivado.pb -notrace -source RegisterController.tcl
