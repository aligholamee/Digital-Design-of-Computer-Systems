...
HD_PWD='C:/Users/Ali Gholami/Desktop/onGoing/Digital Design of Computer Systems/assignments/Assignment_3/_VHDL/grade_mod_counter/grade_mod_counter.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log GenericModCounter.vds -m64 -mode batch -messageDb vivado.pb -notrace -source GenericModCounter.tcl
