...
HD_PWD='C:/Users/Ali Gholami/Desktop/onGoing/Digital Design of Computer Systems/assignments/Assignment_3/_VHDL/q6_analysis/q6_analysis.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log AnalysisQ6.vds -m64 -mode batch -messageDb vivado.pb -notrace -source AnalysisQ6.tcl
