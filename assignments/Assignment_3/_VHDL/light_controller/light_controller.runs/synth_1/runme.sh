...
HD_PWD='C:/Users/Ali Gholami/Desktop/onGoing/Digital Design of Computer Systems/assignments/Assignment_3/_VHDL/light_controller/light_controller.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log LightController.vds -m64 -mode batch -messageDb vivado.pb -notrace -source LightController.tcl
