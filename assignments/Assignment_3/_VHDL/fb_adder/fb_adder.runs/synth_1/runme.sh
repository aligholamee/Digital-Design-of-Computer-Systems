...
HD_PWD='C:/Users/Ali Gholami/Desktop/onGoing/Digital Design of Computer Systems/assignments/Assignment_3/_VHDL/fb_adder/fb_adder.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ADD4.vds -m64 -mode batch -messageDb vivado.pb -notrace -source ADD4.tcl
