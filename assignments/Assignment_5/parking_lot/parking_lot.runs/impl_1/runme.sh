...
HD_PWD='C:/Users/Ali Gholami/parking_lot/parking_lot.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ParkingLot.vdi -applog -m64 -messageDb vivado.pb -mode batch -source ParkingLot.tcl -notrace
