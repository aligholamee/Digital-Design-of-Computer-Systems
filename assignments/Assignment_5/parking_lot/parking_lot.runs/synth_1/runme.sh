...
HD_PWD='C:/Users/Ali Gholami/parking_lot/parking_lot.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ParkingLot.vds -m64 -mode batch -messageDb vivado.pb -notrace -source ParkingLot.tcl
